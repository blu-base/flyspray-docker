...
passwdcrypt = "sha512" ; Available options: "" - chooses best default (currently "crypt"), "crypt", "md5", "sha1", "sha512" Note: md5 and sha1 are considered insecure for hashing passwords (statement date: 2016)
...
[database]
dbtype = "%%DBTYPE%%"        ; Type of database ("mysql" or "pgsql" are currently supported)
dbhost = "%%DBHOST%%"        ; Name or IP of your database server
dbname = "%%DBNAME%%"        ; The name of the database
dbuser = "%%DBUSER%%"        ; The user to access the database
dbpass = "%%DBPASSWD%%"        ; The password to go with that username above
